...
JMP  037C   ; $0334: 4C 7C 03 EA  - Jump to WRITE_INST
...
JMP  037C   ; $0340: 4C 7C 03 EA  - Jump to WRITE_INST
...
JMP  037C   ; $0354: 4C 7C 03 EA  - Jump to WRITE_INST
...
JMP  041C   ; $0400: 4C 1C 04 EA  - Jump to write final NOP
