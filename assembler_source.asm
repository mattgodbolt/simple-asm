...
JMP  0280   ; $023C: 4C 80 02 EA  - No, handle as opcode

; Handle @ directive - jump to handler
JMP  1200   ; $0240: 4C 00 12 EA  - @ directive handler

; Handle # hex data - jump to handler  
JMP  1280   ; $0244: 4C 80 12 EA  - # hex data handler
...
JMP  0300   ; $027C: 4C 00 03 EA  - Jump to table lookup
...
; READ_BYTE:
JSR  0580   ; $0340: 20 80 05 EA  - Call hex conversion
...
JSR  05C0   ; $0384: 20 C0 05 EA  - Convert to nibble
